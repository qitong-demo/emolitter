...
现在主菜单不是冗长的功能列表, 而是一个更像“终端仪表盘”的界面：

- 顶部有品牌头图与副标题
- 中部有默认收信人、情绪空气值、实时流
- 底部把操作压缩为 `Record / View / Settings`
...
为了减少权限焦虑, 当前版本在书信中只记录动作轮廓和窗口标题, 不直接写下你具体键入的字符内容。
